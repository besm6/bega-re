...
ШКОЛА=5400132b;  ИГРА=5400125b; СВЯЗЬ=5400162b;
...
mode=(m0, m1, m2, m3);
% rec1 = _record f1:_array [1..63] _of integer;f2:_array [1..63] _of word;f3:_array [1..63] _of word_end;
rec1 = _array [0..2, 1..63] _of word;
_var g10z, g11z:integer;
...
_(
  l2v2z := 1;
  i := statAr[arg]; code(2цс5=);  statAr[arg] := ; 
  i := statAr[0]; code(2цс5=);  statAr[0] := ; 
_);
...
_(
 ...
 (a) _while input@ <> etx _do _(
  ...
  j := j + 1;
  _if j > 512 _then _(  putInp('SLЕ  {377'); g52z := g52z + [47]; _goto 1405  _);
  INP@ := input@;
  put(INP);
  get(input);
 _);
  _if fin _then _(  INP@ := etx; put(INP); 1405: reset(INP) _);
 _if hardCopy _then _(  writeLN; code(ВИ7=ЗЧ76013,) _)
_);
...
_(
 ...
 _if (curVol <> 0) _then _(  l2v1z := 205277T;  code(2Э0725=,)  _);
 l2v4z :=   toHex( vol );
  l2v1z := 5277T;
 l2v2z := '00    ';
 l2v3z := '0000{377{377';
 ...
 l2v1z := ;
 _if l2v1z = 0 _then curVol := vol _else _(
...
_( (* L2076 *)
 ...
 g32z := 2T;
 l2v7z := ;
  _if (card(l2v7z) > 1) _then _( ГГ('МАШИНА'); writeln(g17z:2) _);
...
');
 ...
 l2v7z := ;
  ...
  2351:
  l2v3z := 0;
  code(Э050165=,ви16=сд/-44/,);
  l2v1z := ;
  _for l2v2z := 1 _to 3 _do _(
  (q) l2v1z := l2v1z * 16; (* сд/-4/ *)
  code(мр=); l2v4z := ;
 l2v3z := l2v3z * 10 + l2v4z;
  _);
 write('ВЕРСИЯ ОС - ');
  write( l2v3z:1 );
 more;
 ...
 _goto 2116;
  ...
  writeln('МОГУТ БЫТЬ: РЕС-УРСЫ, РЕЖ-ИМЫ, ВЫВ-ОД, ВСЕ');
  exit
  _)
  _end;
...
l2v11z, l2v12z, l2v13z, l2v14z:integer;
l2v15z:@page;
l2v16z, l2v17z: boolean;
l2v18z:@rec1; l2v19z, l2v20z: bitset;
l2v21z, l2v29z:_array[0..7] _of integer; 
l2v37z:page;
...
_(
 l3v4z := ' - ';
  ...
  l3v2z := shift(l2v18z@[0, l3v1z].i, 40);
  _if l2v17z _and (l3v2z < l3a1z) _then _( l2v12z := l3v1z;  l2v17z := false _) _else _(
  _select
  (l3v2z = l3a1z): _(
  _if l2v16z _then _(
 2604:
  l3v4z := shift(l2v18z@[2, l3v1z].a, 24);
  _goto 2625
  _) _else _(
  l3v3z := l2v18z@[1, l3v1z].s;
...
_const foo = 77777777В;
 ...
 write('*  ');
 l2v17z := true;
 _for l2v1z := 0 _to 2 _do _(
 l2v5z := l2v1z * 8 + l2v7z + l3a1z;
 _if (l2v5z <= 24) _then _(
   wrOctal( l2v5z, 2 );
 ГГ( '-(' );
 ГГ(   L2563( l2v5z) );
   l2v6z :=shift(l2v15z@[l2v5z].i, 15);
 l2v14z :=l2v14z + l2v6z;
   write(cpar);
   write(l2v15z@[l2v5z].i _mod 32768: 5 );
   write( l2v6z :4  );
 ГГ( '  *  ' );
   _);
   _);
...
_( (* СТАТЕР *)
 ...
 _if INP@ _in digit _then _(
  l2v9z :=   getNum( 10 );
  l2v16z := false;
 _if _not (l2v9z _IN l2v20z) _then _( 
  writeln('НЕТ МАШИНЫ ', l2v9z:1 );
  exit
  _)
 _);
  L1672( false, l2v37z, НУ66, СТАТЗОНА );
  l2v4z := g31z@[1].i;
  l2v11z := g31z@[8].i;
 ...
 _if _not l2v16z _then _(
  ...
  writeln( l2v9z:2 );
 l2v10z := l2v29z[l2v9z];
  _) _else  _if (card(l2v19z) > 1) _then writeln('ВСЕ МАШИНЫ');
 l2v12z := 1;
 l2v13z := l2v21z[l2v9z];
 _for l2v1z := 1 _to 63 _do _(
  _if l2v16z _then 
  l2v15z@[l2v1z].i := l2v15z@[l2v1z].i + l2v15z@[l2v1z + 64].i + l2v15z@[l2v1z+128].i
  _else
  l2v15z@[l2v1z].i := l2v15z@[l2v1z + l2v13z].i;
  _);
  l2v8z := 24 _div 24;
...
_function L3117(i:integer):integer;
 _(
 L3117 := l2v1z@[i]*64 + l2v1z@[i+1];
 _);
...
_( (* 3166 *)
 ...
 writeln(' - ОШИБКА'); exit
  ...
  l2k88z := 7;
  l2k94z := 'ВОПР  ';
  l2k96z := [ 'ИНФШКО', 'ВОПФРА', 'ЗАПАНК', 'ВЫПЖИЗ', 'ПОЛСЕМ', 'КУРДРГ', 'ДРЖЗАМ', 'ОБДОСК',
  'НОТДЕЛ', 'НЕПСЛЖ', 'КРА   '];
  _);
  3: _(
  l2k88z := 7;
  ...
  l2k88z := 5;
  l2k94z := 'СВЯЗЬ ';
  l2k96z := [ 'ИНФШКО', 'АРХПЕР', 'ПОКИКА', 'ГРАА-Д', 'Д-АД-Б', 'Б-ДА-Б', 'Б-АПЕЧ', 'ЭКР   ' ];
  _);
  5: _(
  l2k88z := 4;
  l2k94z := 'ИГРА  ';
  l2k96z := [ 'ИНФШКО', 'LАNШАШ', 'КРЕКАЛ', 'УЗОБЕГ', 'ЛОТПОС', 'ТУР - ' ];
  _);
  6: _(
  l2k88z := 7;
  l2k94z := 'БИБЛ  ';
  l2k96z := ['ИНФШКО', 'ОБЗВЫС', 'ЖУРКАР', 'ПРЕАВТ', 'ЮМОДОЛ', 'ЗАКНОВ', 'СПРПЕЧ', 'ЭКРИДИ',
  'ЭКССФ1', 'СФ2СФ3', '*!*   '  ];
  _);
  7: _(
  l2k88z := 6;
 ...
 'ИСПРАЗ', 'ТИПДОК','ЛИС   '];
  ...
  more;
  _);
  write('ВСЕГО ВЫХОДОВ', l2k91z:7, sp6, 'ВСЕГО ПРИКАЗОВ', l2k86z:5);
  more;
  _if l2k87z = 3 _then _(
  ГГ( 'СЧИЗОН' ); write(eq, L3117(24):5 );
  more;
  ГГ( 'СЧИЗОН' ); write(eq, L3117(26):5 );
  ГГ( '(ТЕСТ)' );
  more;
  ГГ( 'ЗАПЗОН' ); write(eq, L3117(28):5 );
  more;
  _);
...
l2k26z, l2k27z, l2k28z, l2k29z, l2k30z, l2k31z, l2k32z, l2k33z, l2k34z, l2k35z:integer;
...
_(
 ...
 l2k44z := ;
  l2k34z := l2k25z@[3].i;
 l2k30z := shift(l2k34z, 36);
  l2k34z := l2k34z _mod 1000000000000В;
 l2k54z := ;
 l2k31z := 0;
 l2k32z := ;
 ...
 l2k32z := (l2k32z + l2k27z);
  ...
  _if l2k26z = 10 _then _(  _for l2k27z := 1 _to 39 _do write(minus:1); more  _); (* 4010 *)
  write(l2k55z.f[l2k26z], sp:1+0);
  l2k28z := l2k36z[l2k26z];
 l2k29z := l2k46z[l2k26z];
 L3071( (l2k28z _DIV 50) );
 l2k27z := (l2k29z _DIV 50);
  _if (l2k27z >= 360000) _then write( sp:5 ) _else write(sp6);
  L3071( l2k27z );
  _if (l2k28z = 0) _then write('xx': 10) _else
  write( trunc(l2k29z / l2k28z) : 10 );
  more;
  _); (* 4055 *)
  _if (l2k30z > 0) _and (g48z = '417700') _then   writeln('ЧИСЛО ЧП ', l2k30z:4 );
_);
...
_(
 ...
 ГГ( 'ЯЩИК' );
  ...
  l2v5z := (l2v5z + l2v4z);
  write( l2v2z:3 );
  _if g48z = '417700' _then  write( l2v4z:4 );
...
_(
  ...
  _if _not g57z _and hardCopy _then ГГ( ' НОТЫ' );
  _);
  writeln;
  l2v12z := 0;
  l2v11z := ;
 ...
 ГГ( l2k58z[ord(l2k46z[i]) + 3] );
  ...
  write(sp);
  ГГ( l2v15z[l2v6z + 7].a );
  _if _not g57z _and hardCopy _then _(
  write(sp);
  ...
  more
  _); (* 4760 *)  
  writeln(sp:17, 'НОВОСТЬ ПРОЧЛИ =', l2v13z:3, eol:1+0,
          sp:21, l2v10z:5, l2v11z:4, l2v12z:4, eol:1+0);
_);
...
_function L5305(l2a1z:integer):integer;
_(
   code(2сч4=э050135,); 
   L5305 := ;
_);

_function L5311:integer;
...
_(
  ...
  l2v2z := l2v2z + 1;
  l2v1z := minel(l2v3z);
  _if (l2v1z = g17z) _then  L5344 := l2v2z;
  l2v3z := l2v3z - [l2v1z];
  _);
_);

_function L5423(_var l2a1z:twoset; _var l2a2z:boolean):boolean; _label 5433, 5435, 5451;
_var l2v1z:integer;
l2v2z:alfa;
...
_( (* L5423 *)
  rdpg32(НУ66, СТАТЗОНА); _goto 5435;
  5433: _GOTO 10543;
  5435:
  l2v10z := g31z@[8].s;
...
_(
  l2v2z :=   L5261( l2v8z );
  code(э050153=,уи7=7са11,);
_);

_( (* ПАУЗА *)
  _if (40 _in g52z) _and (40 _in g50z) _then _( writeln('НА ПАУЗЕ ВЫ УЖЕ БЫЛИ'); EXIT _);
  statis (20);
  ...
  l2v5z := (l2v5z - (20));
  l2v3z := (l2v3z + 1);
  _if (l2v3z = 5) _then _(  l2v3z := 0; L5641 _);
  code (7э065=,); l2v10z := ;
  _if l2v10z = 'ДЖИН!!' _then _exit loop;
  _); (* 5765 *)
  l2v6z := 0;
  (loop) _(
  _if sel(l2v6z, 0, 2) = 0 _then  L5641;
...
_(
  ...
  write(INP,'{214     ');
  unpck( l2v2z[1], g48z );
  _for l2v1z := 1 _to 4 _do write(INP, l2v2z[l2v1z]:1+0);
  cmd := g48z;
  L2013( cmd, g13z );
  write(INP,' - ', cmd, g13z, '  ВИД=');
  l2v1z :=  L5305(   L5311  );
  mapia( l2v1z, cmd );
  unpck( l2v2z[1], cmd );
...
_( (* СЕТЬ *)
  ...
  reset(INP);
  rewrite(l2v451z);
  _while INP@ <> etx _do _( write(l2v451z, INP@); get(INP) _);
  write(l2v451z, etx);
...
_( (* КАЛЕНД *)   
  ...
  base := T[0, i];
  _if cur = 0 _then _(
  _if ((i = 6) _or (i = 12)) _and (base = 0) _then write(chr(ord('!'))) _else
  ...
  ((i _IN [7..11]) _and (cur <> 0) _and (d - 7 = cur)) _then write(chr(ord('(')))
  _else _if (i _IN [7..11]) _and (cur = d) _then write(cpar) _else
...
_proced L10446(_var l3a1z:text; _var l3a2z: integer; l3a3z:integer);_( code(пб76022=,) _);
_(
  L10446( INP, g37z, 62 );
_);

_proced enter;
_proced L10464(_var l3a1z:text; _var l3a2z: integer; l3a3z:integer);_( code(пб76021=) _);
_(
  L10464( INP, g37z, 62 );
  reset(INP);
  g11z := 1;
...
_(
  ...
  g16z := true;
  g31z := ptr(64000В);
  code(Э050114=,сд/3/=мр,сд/-3/=мр,); g17z := ;
  _if (g14z <> 'ТАМБОВ') _then code(сч=э062,) _else enter;
  10543: L1431;
  _if (12 _IN g52z) _then _( putInp( 'ВОП  {377' ); _goto 10602 _);
  TTIN( 1, true );
  10553: g15z := false;
  ...
  ('БЭС   ' = cmd): БЭСМ;
  ('ДЖИ   ' = cmd) _or
  ('ВОП   ' = cmd): _( _if 43 _IN g52z _then _goto 10543; statis(26); 10602: exec( ВОПРОС )  _);
  ('ИГР   ' = cmd):  exec( ИГРА );
