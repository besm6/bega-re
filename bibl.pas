...
ну1=5420001в; ну2=3420213в; ну3=5420111в; с7005=7005; с384=384; с7=7;
пароль='софия '; влэвм1='0итм и'; влэвм2=' вт ан'; ну4=5420147в;
ну5=5420273в; ну6=6420075в; ну7=4661111в; с248=370в; с113=161в; с6=6;
с158=236в; с400=400; я='я'; c1023=1023; c4=4; eol='{175';etx='{377';
eot='{172'; semi=';     '; sp=' ';dot='.';comma=',';opar='(';cpar=')';
minus='-'; п='п'; д='д'; c87=87; sp6='      '; ornam='-=#=- ';
...
t2=0..2;
t3=0..3;
_var entered:alfa; g11z:alfa; g12z:boolean;
g13z, g14z, g15z: boolean;
g16z:boolean;
g17z:@page;
g18z:@ipage;
g19z, g20z:integer;
g21z, g22z, g23z, g24z, g25z, g26z, g27z: integer;
g28z:_record r:_array[1..7] _of alfa _end;
g35z:_array [1..1] _of alfa;
g36z, g37z, g38z, volNU66:integer;
g40z:boolean;
g41z:integer;
g42z:_array[1..1] _of integer;
g43z:boolean;
g44z, g45z, g46z, g47z, g48z:integer;
g49z:_array[1..1] _of integer;
g50z, g51z, g52z, g53z, g54z, g55z:integer;
g56z:_array [1..3] _of alfa; g59z:integer;
g60z, g61z, g62z:integer;
g63z:_array[1..1] _of boolean;
g64z, g65z:integer;
g66z, g67z, g68z, g69z, g70z:integer;
g71z:bitset;
g72z, g73z, g74z, g75z, g76z, g77z, g78z, g79z, g80z:integer;
g81z:alfa;
g82z:integer;
g83z, g84z, g85z:bitset;
g86z, g87z, g88z:boolean;
g89z, g90z:boolean;
g91z:integer;
...
_(
 ...
 _while (input@ <> etx) _do _(
   _if g88z  _then _(  write(input@) _);
 ...
 put(INP);
 reset(INP);
 _if g88z _then _( writeLN;  code(ви7=зч76013,) _);
 _);

_proced limit; _label 3671;
_var l2v1z:integer; l2v2z, l2v3z:bitset;
_(
 code(=Э0634,);
 l2v1z := ;
 _if ((g78z - l2v1z) < 50) _then _(
...
_(
 ...
 limit;
  code(СЧ77015=); l2v1z := ;
 _if l2v1z = 'Н{3770000' _then  _GOTO 12450;
_);
_proced L3726;
 _(
   _if g88z _then _( MORE; EXIT _);
   write('{172     ');
...
_function L3762(l2a1z:integer):integer;
 _(
   code(=14пв77463,);
 ...
 _);
(*=m-*)
_proced L3771(l2a1z:integer);
_var l2v1z:char;
_(
 l2v1z := chr(l2a1z _div 10);
 write(l2v1z, chr(l2a1z - ord(l2v1z)*10));
 _);

_proced L4003(l2a1z:char);
 _(
 L3576;
   _if (INP@ = l2a1z) _then get(INP);
 L3576;
 _);

_proced P4012(_var l2a1z:_array [1..16] _of char; _var l2a2z: integer);
_var l2v1z, l2v2z:integer;  l2v3z:char;
_(
 l2v2z := 0;
 _for l2v1z := 1 _to 16 _do _(
 l2v3z := INP@;
 _if (l2v3z = etx) _or
  (l2v3z = '(') _or
  (l2v3z = ')') _or
...
_function L4227(l2a1z:integer):alfa;
...
_proced L4431(l2a1z:integer);
_var l2v1z:bitset; l2v2z:alfa; l2v3z:integer;
_(
  freeNU( l2a1z );
  code(ИК75205=7ПА-1,);
 _if g15z _or g14z  _then l2v3z := 1200000000000010C
...
_proced P4511(l2a1z, l2a2z:integer);
...
_( (* 4511 *)
  ...
  code(СД/-10/=МР,);   l2v1z := ;
  _if l2v1z _in letter _then L4431(l2a2z) _else
  _(
  L4465(l2v3z);
  P4337(l2v3z, l2a2z);
  _);
...
_( (* 4712 *)
 ...
 F4712 := false;
 _if INP@ _in digit _then P4650 _else _if INP@ = '(' _then _(
  get(INP);
  (loop) _( P4650; _if INP@ = ',' _then _( get(INP); _goto loop _) _);
...
_function L4760(l2a1z:alfa):alfa;
_var l2v1z:alfa;
_(
...
_proced P4767(l2a1z:alfa; l2a2z:boolean); _label 5032;
_var l2v1z:integer; l2v2z:alfa;
_(
 _for l2v1z := (1) _to g22z _do _(
 l2v2z := g56z[l2v1z];
 _if L4760( l2a1z) <> 'RUВ   ' _then  l2v2z :=   L4760( l2v2z );
 _if (l2a1z = l2v2z) _then _goto 5032;
  _);
  write('РАЗДЕЛА ', l2a1z, ' В ');
 ГГ( влэвм1 );
 writeln(влэвм2, ' НЕТ');
 _GOTO 12450;
5032:
 _if g63z[l2v1z]  _and   g88z _and  _not (3 _IN g71z) _and   l2a2z _then _(
 _if _not g90z _then _(
  g90z := true;
 ...
 _GOTO 12450;
  _);
 _if _not (g27z = (1)) _then  P4511( (1), 44В );
 rdpg32( 44В, g49z[l2v1z] );
 _);

_function L5064(l2a1z:alfa):boolean;
_var l2v1z, l2v2z:integer; l2v3z: alfa;
_(
 L5064 := false;
 _for l2v2z := (1) _to g22z _do _(
   l2v3z :=   L4760( g56z[l2v2z] );
...
_var l2v1z:char; l2v2z, l2v3z, l2v4z, l2v5z, l2v6z, l2v7z, l2v8z, l2v9z, l2v10z, l2v11z:integer;
...
_(
 ...
 l2v4z := -1;
  ...
  _for l2v6z := 1 _to 6 _do _(
   l2v1z := l2v12z[l2v6z];
  l2v8z := ;
  _if (l2v1z = eot) _or (l2v1z = '{127') _then EXIT;
  _if l2v1z _in digit _then l2v18z := true;
  _if l2v18z _then _(
  _if (l2v1z <= '9') _then _(
  l2v10z := l2v10z * 10 + l2v8z;
  _) _else _(
  _for l2v9z := (1) _to l2v3z-1 _do _(
  l2v10z := l2v10z * 100;
  _);
 l2a2z := l2a2z + l2v10z;
...
СОБСТВЕННЫЕ ФАЙЛЫ ВЫЗЫВАЮТСЯ ОДНОИМЕННЫМИ ПРИКАЗАМИ.
 ...
 MORE;
 _);
_function F5274(_var l2a1z:alfa; l2a2z:integer):boolean;
...
ЭВМ, КОТОРЫЙ ЯВЛЯЕТСЯ АВТОНОМНЫМ БЛОКОМ И ИМЕЕТ СВОЙ НАБОР ПРИКАЗОВ.');
   true:  _( writeln('НЕТ ПРИКАЗА ', entered); _goto 5461 _)
   _end _else _(
...
_( (* DOL *)
 ...
 l2v2z := 0;
 l2v20z := 0;
 _if _not (INP@ _in digit) _then  l2v9z := shift(g81z, 32)
  _else l2v9z := L4227(L3762(10));
...
_proced L6102(l2a1z:boolean);
 _(
 _if l2a1z _then write('ОБРАЗЕЦ НЕ НАЙДЕН')
 _else write('ОБРАЗЦЫ НЕ НАЙДЕНЫ');
 writeLN;
_);

_proced L6471(l2a1z:alfa); _label 6625, 6630, 6547, 6557, 6563;
...
l2v24z:_array[1..4] _of unp16;
l2v88z:_array[1..4] _of integer; l2v92z: _array [1..4] _of integer;

_proced P6113; _label 6154, 6217, 6231, 6264, 6301, 6375, 6424, 6441, 6452;
_var l3v1z, l3v2z, l3v3z, l3v4z, l3v5z, l3v6z, l3v7z, l3v8z, l3v9z, l3v10z, l3v11z, l3v12z, l3v13z, l3v14z:integer;
l3v15z:unp16;
l3v31z:char;
l3v32z:boolean;
l3v33z:_array [1..4] _of integer;
_(
 l3v14z := (1);
 l3v32z := false;
 ...
 l2v13z := 0;
 l2v22z := ;
  _for l3v4z := 1 _to 4 _do _(
   l3v7z := (l3v7z + (1));
  l3v6z := (l3v6z + (1));
  P4012(l2v24z[l3v4z], l3v9z);
  l2v22z := l2v22z | [l3v4z];
 l2v88z[l3v4z] := l3v9z;
 l3v31z := INP@;
6154:
  _select
  (l3v31z = ')') | (l3v31z = etx) :  _goto 6217;
  (l3v31z = '+') | (l3v31z = ' ') : get(INP);
  (l3v31z = ',') : _(
  _if (l3v4z = 4) _then _goto 6217;
  l2v92z[l3v5z] := l3v7z;
 l3v7z := 0;
 l2v7z := (l2v7z + (1));
 l3v5z := (l3v5z + (1));
  ...
  _);
  true: _(
  _while (l3v31z <> ')') & (l3v31z <> etx) &
  (l3v31z <> '+') &  (l3v31z <> ',') & (l3v31z <> ' ') _do _(
  get(INP);
  l3v31z := INP@
  _);
  _goto 6154;
 ...
 l3v11z := l2v3z;
 l3v12z := l2v1z;
 _for l3v7z := (1) _to 4 _do l3v33z[l3v7z] := 0;
 _for l3v4z := 1 _to l2v7z _do _(
   l3v2z := l3v2z + l2v92z[l3v4z];
   _for l3v8z := l3v1z _to l3v2z _do _(
  6264:
     _if (l3v8z _IN l2v23z) _then _(
     _if _not l3v32z _then _(  l3v9z := l2v88z[l3v8z];  l3v15z := l2v24z[l3v8z]  _);
  6301:
  ...
  _select
  (l3v31z = eot) : _(
   _if l3v4z >= l2v7z _then _(
     g13z := l2v10z _or g13z;
     _if _not l2v10z _and l2v14z _then L6102((l2v7z = 1) & (l2v92z[1] = 1)) ;
     _GOTO 6630;
  _) _else _goto 6452;
   (* 6333 *)
  _);
  ...
  _if l3v14z = l3v9z _then _(
  l3v33z[l3v4z] := l3v33z[l3v4z] + 1;
  l2v23z := l2v23z - [l3v8z];
 _if (l3v33z[l3v4z] = l2v92z[l3v4z]) _then _(
  l2v3z := l3v11z;
  l2v1z := l3v12z;
  l2v11z := true;
  l2v10z := ;
  ...
  l3v32z := false;
  l3v14z := 1;
  6424: _if (l3v8z >= l3v2z) _then _goto 6452;
  l3v8z := l3v8z + 1;
  l2v3z := l3v11z;
  l2v1z := l3v12z;
  _goto 6264;
...
_(
 l2v10z := l2a1z;
  ...
  _for l2v8z := 1 _to 6 _do _(
   l2v9z := l2v1z[l2v8z];
  _if _not (l2v9z _in letter) _and (l2v9z <> ' ') _and (l2v9z <> '.') _then  l2v7z := true;
  _); (* 7006 *)
...
l2v4z, l2v5z:alfa;
l2v6z, l2v7z, l2v8z, l2v9z, l2v10z,
l2v11z, l2v12z, l2v13z, l2v14z:integer; l2v15z, l2v16z: boolean;
...
_var l3v1z:integer; l3v2z:unp6; l3v8z:alfa;
_(
...
_var l3v1z:integer; l3v2z, l3v8z:unp6;
_(
 unpck( l3v2z[1], l3a1z );
 unpck( l3v8z[1], l3a2z );
 F7074 := true;
 _for l3v1z := 1 _to l2v14z _do 
  _if l3v2z[l3v1z] <> l3v8z[l3v1z] _then _( F7074 := false; EXIT _)
_);
...
_var l3v1z, l3v2z:integer; l3v3z:char; l3v4z:boolean; l3v5z:unp6;
_(
 unpck( l3v5z[1], l3a1z );
 l3v4z := false;
 _for l3v1z := (1) _to 6 _do _(
...
_var l3v1z:alfa; l3v2z, l3v3z, l3v4z:integer; l3v5z:unp6;
_(
 _for l3v2z := (1) _to 6 _do l3v5z[l3v2z] := '0';
 l3v4z := 0;
 l3v2z := ;
  ...
  l3v3z :=   L3762( 10 );
  _if (l3v3z = 0) _or (l3v2z > 6) _or (l3v2z > 1) _and (l3v3z > 99) _or (l3v4z > 5)
  _then _( write('ОШИБКА В РУБРИКЕ'); L3726; _GOTO 12450 _); (* 7251 *)
  _if (l3v2z = (1)) _then _select
  (l3v3z = (501)) : l3v3z := 1;
  (l3v3z = (502)) : l3v3z := 2;
  (l3v3z = (473)) : l3v3z := 3;
  (l3v3z = (474)) : l3v3z := 4;
...
_proced L7307; _( _if l2v16z  _then  deq41; _);

_proced L7314(l3a1z:char);
_(
 write(l3a1z, ' - НЕПОНЯТНО');
 L3726;
_);
_proced P7324;
...
_( (* ZAKAZ *)
 ...
 _if (volNum( 4, 4) = 0) _then _(
  ...
  ГГ( влэвм1 );
  ГГ( влэвм2 );
   writeln('ЗАКАЗЫ НЕ ОБСЛУЖИВАЮТСЯ');
   _GOTO 12450;
  _);
 _if g15z _then _(
  l2v16z := INP@ <> 'П';
  7427:
  _if l2v16z _then  enq41;
  rdpg32( 41В, 10 );
  (*=c-*)l2v10z := g17z@[1];(*=c+*)
  ...
  l2v17z := true;
  _if INP@ _in digit
  _then _( l2v11z := L3762(10) * 100; l2v3z := L4227(l2v11z) _)
  _else l2v18z := F5274(l2v3z, 6);
  (q) _exit q _);  _); (* 7500 *)
  (loop) _for l2v7z := (1) _to l2v10z _do _(
 l2v11z := l2v7z * 11;
 l2v4z := g17z@[l2v11z];
 l2v18z := l2v17z _and (l2v4z = l2v3z);
  _if _not l2v16z _or l2v18z _or l2v15z _then _(
  write( l2v7z:5 );
 ...
 _for l2v6z := 4 _to 6 _do write(l2v45z[l2v6z]);
  L3726;
  _); (* 7606 *)
  _if _not l2v16z _or l2v18z _then
    _for l2v8z := 1 _to 10 _do _(
      l2v2z := g17z@[l2v11z + l2v8z];
  ...
  _for l2v7z := 1 _to 6 _do _(
  _if (INP@ _in letter) _or (INP@ _in digit) _then _(
    l2v33z[l2v7z] := INP@; get(INP)
  _) _else l2v33z[l2v7z] := l2v1z;
  _); (* 7672 *)
  pck(l2v33z[1], l2v2z);
  write(l2v2z, sp);
  _for l2v7z := 1 _to l2v10z _do _(
  l2v11z := l2v7z * 11;
  _if (g17z@[l2v11z] = l2v2z) _then _(
    _if (l2v7z <> l2v10z) _then _(
   _for l2v7z := (l2v7z + (1)) _to l2v10z _do _(
  l2v8z := l2v7z * 11 + 64000В;
  l2v20z := ptr(l2v8z - 11);
  l2v21z := ptr(l2v8z);
  l2v20z@ := l2v21z@;
  _);
  _) _else (* 7736 *) l2v21z := ptr(l2v10z * 11 + 64000В);
  _for l2v8z := 0 _to 10 _do l2v21z@[l2v8z] := '000000';
  l2v10z := l2v10z - 1;
  g17z@[1] := ;
 wrpg32( 41В, 10 ); L7307; write('ИСКЛЮЧЕН'); L3726; EXIT;
  ...
  (INP@ = 'У') : _(
   l2v9z := l2v10z;
   _while F6631(l2v7z, l2v8z, l2v9z) _do _(
   l2v15z := false;
   l2v20z := ptr(l2v7z * 11 + 64000В);
   unpck(l2v33z[1], l2v20z@[0]);
   l2v21z := ptr(l2v8z * 11 + 64000В);
  ...
  _);
  true: (* 10071 *) _(  L7307; L7314( INP@ ); EXIT; _)
  _end;
  EXIT;
 _); (* 10076 *)
 _if g14z _then _(
 ...
 _if l2v19z _then _(  l2v16z := true; _goto 7427 _);
 l2v4z :=   F7044;
  _) _else  l2v4z := g81z;
  ...
  _if (l2v1z = '+') _then _(
  _for l2v7z := 1 _to 6 _do _(
  rdpg32( 44В, 0 + l2v7z - 1 );
 (*=c-*)l2v11z := sel(g17z@[2], 36, 12); (* избыточно *)
 l2v10z := shift(g17z@[3], 36);(*=c+*)
 _for l2v8z := (1) _to l2v10z _do 
  _if F7074( l2v2z, g17z@[l2v11z + l2v8z - 1]) _then _exit a;
  _);
  write('РУБРИКА  '); L7131( l2v2z ); write('  НЕ СУЩЕСТВУЕТ'); L3726; EXIT;
  _)
  _);
  l2v1z _in digit: _( l2v1z := '+'; _goto 10136 _);
  true: _( L7314(l2v1z); EXIT _)
  _end;
  10211:
  l2v16z := l2v1z <> etx;
  _if l2v16z _then enq41;
 ...
 _if (l2v10z > 68) _then _goto 10225;
  ...
  l2v10z := l2v10z + 1;
  g17z@[1] := ;
  _if (l2v10z > 68) _then _(  write('ДЛЯ '); L7120; write(' НЕТ МЕСТА'); L3726; EXIT _);
  l2v11z := l2v10z * 11;
  g17z@[l2v11z] := l2v4z;
  10270:
  l2v13z := 0;
  _for l2v7z := 1 _to 10 _do
  _if g17z@[l2v11z + l2v7z] <> '000000' _then  l2v13z := l2v13z + 1;
  _select
  (l2v1z = etx) : _(
  _if (l2v13z = 0) _then_( 10306:  write('ЗАКАЗОВ У '); L7120; write(' НЕТ'); L3726; EXIT _);
  10315: write(l2v4z, ' - ВАШИ ЗАКАЗЫ:'); L3726;
   _for l2v7z := 1 _to l2v13z _do _(
    write(sp:7); L7131(g17z@[l2v11z + l2v7z] ); L3726;
   _); EXIT
  _);
  (l2v1z = '+'): _(
   _for l2v7z := 1 _to l2v13z _do 
  _if g17z@[l2v11z + l2v7z] = l2v2z _then _(
  L7307; write('ЗАКАЗ  '); L7131( l2v2z ); write('  У '); L7120; write(' УЖЕ ЕСТЬ'); L3726; EXIT
  _);
  ...
  _for l2v7z := 1 _to l2v13z _do _(
  _if g17z@[l2v11z + l2v7z] = l2v2z _then _(
 _if l2v7z <> l2v13z _then  g17z@[l2v11z + l2v7z] := g17z@[l2v11z + l2v13z];
  g17z@[l2v11z + l2v13z] := '000000';
  l2v13z := l2v13z - 1;
  _goto 10402;
    _)
  _);
   L7307; write('ЗАКАЗА  '); L7131( l2v2z ); write('  У '); L7120; write(' НЕТ'); L3726;
  _goto 10315;
  _)
  _end;
_);
...
_var l2v1z:alfa;
_(
 _if L5064( 'БЭС   ') _or L5064( 'ЗУ    ') _or L5064( 'ЯЗ    ') _then _(
 _if INP@ = etx _then _(
 writeln('УКАЖИТЕ ТЕМУ ОБЗОРА');
 writeln('ЕСТЬ:');
 _if L5064( 'БЭС   ') _then writeln('  БЭСМ');
 _if L5064( 'ЗУ    ') _then writeln('  ЗУ (ЗАПОМИНАЮЩИЕ УСТРОЙСТВА)');
 _if L5064( 'ЯЗ    ') _then writeln('  ЯЗ (ЯЗЫКИ ПРОГРАММИРОВАНИЯ)');
 TTIN( false );
  _);
 _if F5274( l2v1z, 3) _then _(
 _if (l2v1z <> 'БЭС   ') _and ('ЗУ    ' <> l2v1z) _and ('ЯЗ    ' <> l2v1z) _then _(
 write('ОБЗОРА ', l2v1z, ' В '); ГГ( влэвм1 ); writeln(влэвм2, ' НЕТ');
 _GOTO 12450;
  _);
 stats( 3 );
 L6471( l2v1z );
...
_(
 ...
 _GOTO 12450;
  ...
  l2v3z := (l2v3z + (1));
  write( l2v19z:8 );
 _if (l2v3z = 5) _then _(  MORE; l2v3z := 0 _);
  _);
  _); (* 10642 *)
  _if (l2v3z <> 0) _then  MORE;
  TTIN( false );
  _); (* 10647 *)
  l2v18z :=   F5274( l2v19z, 3 );
 ...
 l2v3z := -1;
  ...
  (l2v11z = '$') : _( _if l2v18z _then _exit loop; l2v18z := true; _goto 11014 _);
  (l2v11z = ' ') : _( _if l2v9z = 0 _then _goto 11014 _)
  _end;
...
_function F11021:integer;
_var d:integer;
_(
 code(Э050114=,); d := ;
  F11021 := ((((sel(d, 16, 4) * 10 + sel(d, 20, 4)) * 10 + sel(d, 28, 1)) * 10 + sel(d, 24, 4)) * 10 + sel(d, 33, 2)) * 10 + sel(d, 29, 4);
  _);

_function F11051:alfa;
_var l2v1z, l2v2z:integer; l2v3z:unp6; l2v9z:alfa;
_(
 code(Э05310=,);
 l2v1z := ;
...
_function L11140(l2a1z:boolean):boolean; _label 11150;
...
_(
 ...
 _if (26 _IN g85z) _then _(
  11150: _if l2a1z _then writeln('РОМАН ЗАКРЫТ');
  L11140 := false;
  EXIT;
  _);
  _if g71z * [2] = [2] _then _(
  _if l2a1z  _then  write('ДЛЯ ВАС ');
  _goto 11150;
  _);
  l2v3z :=   F11021;
 ...
 L11140 := false;
 _if l2a1z  _then  writeln('РОМАН СЕЙЧАС ЗАКРЫТ');
 _repeat
 l2v2z := (l2v2z + (1));
 ...
 L3771( l2v1z );
  write(dot);
 L3771( l2v2z );
 writeln(' - СЕЙЧАС', F11051);
  _);
 EXIT;
  _);
  _until l2v2z >= 47;
 _if l2a1z _then writeln('СЕГОДНЯ НЕ ОТКРОЕТСЯ');
 _)
_);
...
_proced L11645; _( writeln('ПРИКАЗ НЕ РЕАЛИЗОВАН') _);
...
_(
 ...
 writeln('ВЫКЛЮЧЕНА ПЕЧАТЬ АЦПУ');
  ...
  _);
  (INP@ = etx) : _(
  _if g88z _then _goto 2 _else _goto 1;
  _);
...
_(
 ...
 writeln('ВЫКЛЮЧЕНА ВЫДАЧА НА ЭКРАН');
  ...
  _);
  (INP@ = etx) : _(
  _if g90z _then _goto 2 _else _goto 1;
  _);
  true:  writeln('НЕПОНЯТНО')
  _end
_);
...
_(
 ...
 _if (l2a1z <> (5420147C)) _and (l2a1z <> (5420273C)) _then  stats( 22 );
 P11756;
 P12111( INP, g70z, 76В );
 _);
...
_(
 P12161( INP, g70z, 76В );
  g26z := sel(g73z, 32, 3);
  g14z := L4227(7005 * 100) = g81z;
  g15z := g81z = '417700';
 P12002;
  _if (2 _IN g85z) _then g85z := g85z - [2] _else _(
  writeln( ornam:18, '  ВЫ ВОШЛИ В БЛОК БИБЛИОТЕКИ  ', ornam);
  _if L5472( (1)) _and L5064( 'DОL   ') _then  DOL( true );
  _);
 _GOTO 12453;
 _);
_proced secret(l2a1z:boolean);
 _(
...
_(
 ...
 _for l2v7z := (1) _to 6 _do
  _if (input@ = etx) _then  l2v1z[l2v7z] := ' '
  _else  _( l2v1z[l2v7z] := input@; get(input) _);
 pck(l2v1z[1], l2a1z);
 _);

 _proced L12302(_var l2a1z:alfa);
_var l2v1z:unp6; l2v7z:integer; l2v8z:alfa;
_(
 L3576;
 ...
 unpck(l2v1z[1], l2v8z );
 l2v7z := (1);
  _while ((INP@ _in letter) _or (INP@ _in digit)) _and (l2v7z < 7) _do _( 
  l2v1z[l2v7z] := INP@;
  get(INP);
 l2v7z := (l2v7z + (1));
  _);
...
_(
 reset(INP);
 l2v1z := F5274( entered, 3 );
 l2v1z := (entered = 'БИБ   ') _and F5274( entered, 3 );
 _);
_proced L12371(l2a1z:integer);
_var l2v1z:integer;
_(
  code(ви=Э0650,уи7=7Э06550,);
 l2v1z := ;
  l2v1z := sel(l2v1z, 41, 6);
 _if (l2v1z < l2a1z) _then _(
  l2v1z := (l2a1z - l2v1z);
  code(=Э050177,);
 l2v1z := ;
 _if l2v1z <> 0 _then _(  writeln('НЕТ РЕСУРСА ПАМЯТИ. ПОПРОБУЙТЕ ЕЩЕ РАЗ.'); _GOTO 12450 _);
  _);
  _);

_(

  g28z := [ 'РУБРИК', 'RUВ2  ', 'RUВ3  ', 'RUВ4  ', 'RUВ5  ', 'RUВ6  ', 'ЮМОР  '];
  g17z := _NIL;
  g18z := ;
  g21z := 1;
...
12450:
  ...
  g12z := false;
 12453:
   _if F5274(entered, 3) _then _select
  ('СТА   ' = entered) :  exec( (5420111C) );
  ('КОН   ' = entered) :  12465: exec( (3420213C) );
  ('ПЕЧ   ' = entered) :  ПЕЧ;
  ('ЭКР   ' = entered) :  ЭКР;
  ('ПОЧ   ' = entered) :  exec( (5420001C) );
  ('БИБ   ' = entered) : _if INP@ = etx _then _goto 12450 _else _goto 12453;
  ('ИНФ   ' = entered) :  INF;
  ('ШКО   ' = entered) :  SCHOOL;
  ('ИДИ   ' = entered) :  GOSTEP;
  ('РОМ   ' = entered) : _(  P4511( 3, 44В ); _if volNum(4,4) = 0 _then  L4136 _else ROMAN _);
  ('СИГ   ' = entered) : _(
  g12z := false; g85z := g85z + [2]; P4511(2, 44В); L12371(15); exec( (5420147C) )
  _);
  ('БАН   ' = entered) : _(
  passwd( g11z );
  ...
  P12350;
  L6471( 'RUВ6  ' );
  _if _not g13z _then  L6102( true );
  _);
  ('СПР   ' = entered) : _(
  g12z := false; 
  stats( 13 );
  ...
  g16z := true; L12302( entered );
  _for g23z := 1 _to g22z _do _if (entered = g56z[g23z]) _then _exit a;
  writeln('В КАТАЛОГЕ НЕТ ИМЕНИ ', entered);
  _goto 12450;
  _) (* 12653 *) _else 
 ...
 _if (g24z > (677777C)) _or (g24z < (300000C)) _or (g25z = 0) _then _(
  ...
  writeln('ДАЙТЕ ИМЯ ФАЙЛА');
   write('ЕСТЬ:');
  _for g23z := 1 _to g22z _do _(
  write(g56z[g23z]: 7);
  _if g23z _mod 4 = 0 _then _(writeln; code(иа=); _if g23z <> g22z _then write('     ') _);
  _);
  _if (g22z _MOD 4 <> 0) _or (g22z = 0) _then _( code(иа=иа,); writeln _);
  _goto 12450
  _);
  _if _not g14z _and _not g15z _and _not (26 _in g83z) _then _( 
    passwd( entered );
    _if (entered <> 'СОФИЯ ') _then _(  writeln('НЕВЕРНЫЙ ПАРОЛЬ'); _goto 12450 _);
  _);
  L12371( (16) );
 _if g16z _then  P4511( (1), 44В );
  g85z := g85z  + [2];
 g12z := false;
 g83z := g83z + [26];
 exec( (4661111C) );
  _);
  ('ВЫС   ' = entered) : _(  stats( 4 ); L6471( entered ) _);
  ('ЖУР   ' = entered) : _(  stats( 5 ); g13z := INP@ = etx;
  L6471( entered ); P12350; L6471( 'JUR   ' ); P12350;
  _if _not g13z _then  L6102( true );
  _);
  ('КАР   ' = entered) : L11645;
  ('ПРЕ   ' = entered) : _( stats( 7 ); L6471( entered ) _);
  ('АВТ   ' = entered) : _( stats( 8 ); L6471( entered ) _);
  ('БЕН   ' = entered) : _( stats( 3 ); L6471( entered ) _);
  ('ЮМО   ' = entered) : _( stats( 9 );
  _if INP@ _in digit _then  writeln(' .....ПОЕЗД УШЕЛ.....') _else L6471( entered );
  _);
  ('ДОЛ   ' = entered) : _( stats( 10 ); L6471( entered ) _);
  ('DОL   ' = entered) : DOL( true );
  ('ЗАК   ' = entered) : ZAKAZ;
  ('ПОК   ' = entered) : POKAJI;
  ('НОВ   ' = entered) : P5205;
  ('ВЫХ   ' = entered) : _goto 12465;
  L5064( entered) : L6471( entered );
  true: _if g12z _and _not (13 _in g85z) _then   13074: writeln('В БЛОКЕ НЕТ ПРИКАЗА ', entered)
  _else _goto 12465
