...
$prog =~ s@12,VTM,([^;]+);14,VJM,P/EL *@eoln(\1)@g;
$prog =~ s@12,VTM,([^;]+);14,VJM,P/GF *@get(\1)@g;
$prog =~ s@12,VTM,([^;]+);14,VJM,P/PF *@put(\1)@g;
$prog =~ s@12,VTM,([^;]+);14,VJM,P/RF *@reset(\1)@g;
$prog =~ s@12,VTM,([^;]+);14,VJM,P/TF *@rewrite(\1)@g;
